...
class MySectionUnmarshal : public gnilk::BaseUnmarshal {
public:
    MySectionUnmarshal() = default;
    MySectionUnmarshal(const std::string &name) : sectionName(name) {

    }
    virtual ~MySectionUnmarshal() = default;
...
class MultiSectionUnmarshal : public BaseUnmarshal {
public:
    MultiSectionUnmarshal() = default;
    virtual ~MultiSectionUnmarshal() = default;
    void DeserializeFrom(IDecoder &decoder) {
...
public:
    MySectionUnmarshal sectionA = MySectionUnmarshal("sectionA");
    MySectionUnmarshal sectionB = MySectionUnmarshal("sectionB");
};
...
extern "C" int test_iniunmarshal_multisection(ITesting *t) {
    ...
    MultiSectionUnmarshal multiSection;
